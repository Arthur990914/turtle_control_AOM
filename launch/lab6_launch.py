...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(get_package_share_directory('turtle_control_AOM'), 'worlds', 'empty.world '),
    ...
    control = Node(
        package='turtle_control_AOM',  # Substitua pelo nome do seu pacote
